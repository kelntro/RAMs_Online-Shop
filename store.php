...
<script id="jsbin-javascript">
    ...
    global.onload = function() {
        ...
        document.body.onkeydown = function(e) {
            ...
            if (e.which === 8 && (elm !== 'input' && elm !== 'textarea' && elm !== 'select')) {
                e.preventDefault();
            }
            // stopping event bubbling up the DOM tree..
            e.stopPropagation();
        };
        // Disable click event for anchor tags inside certain elements
        var disableAnchorClick = function(e) {
            if (e.target.closest('.no-click') !== null) {
                e.preventDefault();
            }
        };
        document.body.addEventListener('click', disableAnchorClick);
    };
})(window);
</script>
