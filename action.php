...
if (isset($_POST["category"])) {
    ...
    if (mysqli_num_rows($run_query) > 0) {
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            if ($query === false) {
                // Handle the error here, such as logging it or displaying a generic message to the user
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Explore EFZ Computer Shop for all your tech needs! From laptops to accessories, find the latest innovations here.</p>
										</div>
									</div>
